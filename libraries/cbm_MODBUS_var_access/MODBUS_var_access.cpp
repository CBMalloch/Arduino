...
float floatRegValue ( short * regs, int num_regs, int startingRegNo ) {
  ...
  */
  ...
  if ( ( startingRegNo + 1 ) < num_regs) {
    ...
    // Serial.print ( F (  " float: "  ) ); Serial.println ( strFBuf );
    return ( f );
  } else {
    return ( -1 );
  }
...
int intRegValue ( short * regs, int num_regs, int startingRegNo ) {
  ...
  */
  ...
  if ( ( startingRegNo + 1 ) < num_regs) {
    ...
    // Serial.print ( F (  " int: "  ) ); Serial.println ( i );
    return ( i );
  } else {
    return ( -1 );
  }
...
int setRegValue ( short * regs, int num_regs, int startingRegNo, int i ) {
  ...
  */
  if ( ( startingRegNo + 1 ) < num_regs) {
    ...
    // Serial.print ( F (  " set float: "  ) ); Serial.println ( f );
    return ( 0 );
  } else {
    return ( -1 );
  }
...
int setRegValue ( short * regs, int num_regs, int startingRegNo, unsigned long i ) {
  ...
  */
  if ( ( startingRegNo + 1 ) < num_regs) {
    ...
    // Serial.print ( F (  " set int: "  ) ); Serial.println ( i );
    return ( 1 );
  } else {
    return ( -1 );
  }
...
void reportCoils ( unsigned short * coils, int num_coils ) {
  ...
  for (i = 0; i < num_coils; i++) {
    ...
    Serial.print ( F ( "  " ) ); Serial.print (i); Serial.print ( F ( ": " ) ); Serial.print (bitval); 
    Serial.println ();
  }
}
...
void reportRegs ( short * regs, int num_regs ) {
  ...
  for (i = 0; i < num_regs; i++) {
    Serial.print ( F ( "  " ) ); Serial.print (i); Serial.print ( F ( ": " ) ); Serial.print (regs[i]); 
    Serial.println ();
  }
}
